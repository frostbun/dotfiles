...
sudo sed -i 's/^auto_adb = False/auto_adb = True/' /var/lib/waydroid/waydroid.cfg
...
sudo venv/bin/python main.py install gapps

read -p "Open Waydroid & press [Enter] to continue..."
sudo venv/bin/python main.py certified
